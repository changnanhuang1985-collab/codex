...
- `AI_11_Chief_CIO_Super_Admin.md`
  - `Orion`：changnan_codex 超级管理员 / 首席 CIO，负责整个工作空间日常管理、AI 工作模式治理、工具生态建设与未来工作方式升级
...
- 需要从 `changnan_codex` 全局管理、AI 工作模式升级、工具生态建设和未来工作方向上统筹时，调用 `Orion`
...
11. `Orion` 负责 changnan_codex 级别运营治理、AI 工作方式升级与未来工作模式探索
